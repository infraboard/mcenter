...
var file_apps_user_pb_rpc_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0xf5, 0x02, 0x0a, 0x11, 0x55,
	...
	0x65, 0x6e, 0x32, 0xbc, 0x01, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12, 0x58, 0x0a, 0x09, 0x51, 0x75,
...
var file_apps_user_pb_rpc_proto_goTypes = []interface{}{
	...
	(*UserSet)(nil),               // 14: infraboard.mcenter.user.UserSet
	(*User)(nil),                  // 15: infraboard.mcenter.user.User
}
var file_apps_user_pb_rpc_proto_depIdxs = []int32{
	...
	0,  // 8: infraboard.mcenter.user.RPC.QueryUser:input_type -> infraboard.mcenter.user.QueryUserRequest
	1,  // 9: infraboard.mcenter.user.RPC.DescribeUser:input_type -> infraboard.mcenter.user.DescribeUserRequest
	14, // 10: infraboard.mcenter.user.RPC.QueryUser:output_type -> infraboard.mcenter.user.UserSet
	15, // 11: infraboard.mcenter.user.RPC.DescribeUser:output_type -> infraboard.mcenter.user.User
