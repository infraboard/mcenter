...
var file_mcenter_apps_service_pb_rpc_proto_rawDesc = string([]byte{
...
var (
	...
	file_mcenter_apps_service_pb_rpc_proto_rawDescData []byte
)

func file_mcenter_apps_service_pb_rpc_proto_rawDescGZIP() []byte {
	file_mcenter_apps_service_pb_rpc_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_service_pb_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_service_pb_rpc_proto_rawDesc), len(file_mcenter_apps_service_pb_rpc_proto_rawDesc)))
	})
...
var file_mcenter_apps_service_pb_rpc_proto_goTypes = []any{
...
func file_mcenter_apps_service_pb_rpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_service_pb_rpc_proto_rawDesc), len(file_mcenter_apps_service_pb_rpc_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
