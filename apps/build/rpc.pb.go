...
type RunBuildRequest struct {
	...
	// 所属列表
	// @gotags: bson:"service_tags" json:"service_tags"
	ServiceTags map[string]string `protobuf:"bytes,1,rep,name=service_tags,json=serviceTags,proto3" json:"service_tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"service_tags"`
	// 所属列表
...
func (x *RunBuildRequest) GetServiceTags() map[string]string {
	if x != nil {
...
type AutoDeployOptions struct {
	...
	// @gotags: bson:"deploy_tags" json:"deploy_tags"
	Tags map[string]string `protobuf:"bytes,14,rep,name=tags,proto3" json:"deploy_tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"deploy_tags"`
}
...
func (x *AutoDeployOptions) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_apps_build_pb_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2e,
	...
	,
	...
	0x74, 0x6f, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a,
	0x3e, 0x0a, 0x10, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22,
	0xc5, 0x01, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x6f, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x4f, 0x70,
	...
	0x6e, 0x76, 0x73, 0x12, 0x49, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x35, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d,
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x41, 0x75, 0x74,
	0x6f, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x54,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xbb, 0x01, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a,
	...
	,
...
var file_apps_build_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_apps_build_pb_rpc_proto_goTypes = []interface{}{
	...
	nil,                         // 3: infraboard.mcenter.build.RunBuildRequest.ServiceTagsEntry
	nil,                         // 4: infraboard.mcenter.build.AutoDeployOptions.TagsEntry
	(*request.PageRequest)(nil), // 5: infraboard.mcube.page.PageRequest
	(*BuildTask)(nil),           // 6: infraboard.mcenter.build.BuildTask
	(*BuildTaskSet)(nil),        // 7: infraboard.mcenter.build.BuildTaskSet
}
var file_apps_build_pb_rpc_proto_depIdxs = []int32{
	3, // 0: infraboard.mcenter.build.RunBuildRequest.service_tags:type_name -> infraboard.mcenter.build.RunBuildRequest.ServiceTagsEntry
	1, // 1: infraboard.mcenter.build.RunBuildRequest.auto_deploy_options:type_name -> infraboard.mcenter.build.AutoDeployOptions
	4, // 2: infraboard.mcenter.build.AutoDeployOptions.tags:type_name -> infraboard.mcenter.build.AutoDeployOptions.TagsEntry
	5, // 3: infraboard.mcenter.build.QueryBuildRequest.page:type_name -> infraboard.mcube.page.PageRequest
	...
	6, // 6: infraboard.mcenter.build.RPC.RunBuild:output_type -> infraboard.mcenter.build.BuildTask
	7, // 7: infraboard.mcenter.build.RPC.QueryBuild:output_type -> infraboard.mcenter.build.BuildTaskSet
