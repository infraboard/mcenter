...
type QueryBuildRequest struct {
	...
	// 所属服务
	// @gotags: json:"service"
	Service string `protobuf:"bytes,4,opt,name=service,proto3" json:"service"`
	// 构建Id
...
func (x *QueryBuildRequest) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
var file_apps_build_pb_rpc_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2f, 0x70, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x11,
	0x0a, 0x0f, 0x52, 0x75, 0x6e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0xb6, 0x01, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x75, 0x69, 0x6c, 0x64,
	...
	,
	...
	0x65, 0x72, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x06, 0x70,
...
var file_apps_build_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apps_build_pb_rpc_proto_goTypes = []interface{}{
	(*RunBuildRequest)(nil),     // 0: infraboard.mcenter.build.RunBuildRequest
	(*QueryBuildRequest)(nil),   // 1: infraboard.mcenter.build.QueryBuildRequest
	(*request.PageRequest)(nil), // 2: infraboard.mcube.page.PageRequest
	(*BuildTask)(nil),           // 3: infraboard.mcenter.build.BuildTask
	(*BuildTaskSet)(nil),        // 4: infraboard.mcenter.build.BuildTaskSet
}
var file_apps_build_pb_rpc_proto_depIdxs = []int32{
	2, // 0: infraboard.mcenter.build.QueryBuildRequest.page:type_name -> infraboard.mcube.page.PageRequest
	0, // 1: infraboard.mcenter.build.RPC.RunBuild:input_type -> infraboard.mcenter.build.RunBuildRequest
	1, // 2: infraboard.mcenter.build.RPC.QueryBuild:input_type -> infraboard.mcenter.build.QueryBuildRequest
	3, // 3: infraboard.mcenter.build.RPC.RunBuild:output_type -> infraboard.mcenter.build.BuildTask
	4, // 4: infraboard.mcenter.build.RPC.QueryBuild:output_type -> infraboard.mcenter.build.BuildTaskSet
