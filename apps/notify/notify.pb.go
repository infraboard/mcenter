...
func file_mcenter_apps_notify_pb_notify_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mcenter_apps_notify_pb_notify_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
