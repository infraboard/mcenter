...
var file_mcenter_apps_notify_pb_rpc_proto_rawDesc = []byte{
...
var (
	...
	file_mcenter_apps_notify_pb_rpc_proto_rawDescData = file_mcenter_apps_notify_pb_rpc_proto_rawDesc
)

func file_mcenter_apps_notify_pb_rpc_proto_rawDescGZIP() []byte {
	file_mcenter_apps_notify_pb_rpc_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_notify_pb_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(file_mcenter_apps_notify_pb_rpc_proto_rawDescData)
	})
...
var file_mcenter_apps_notify_pb_rpc_proto_goTypes = []interface{}{
...
func file_mcenter_apps_notify_pb_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mcenter_apps_notify_pb_rpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_mcenter_apps_notify_pb_rpc_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_mcenter_apps_notify_pb_rpc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_mcenter_apps_notify_pb_rpc_proto_rawDesc = nil
