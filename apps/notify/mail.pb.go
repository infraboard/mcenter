...
var file_mcenter_apps_notify_pb_mail_proto_rawDesc = string([]byte{
	...
	0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x22, 0x86,
	0x01, 0x0a, 0x0a, 0x4d, 0x61, 0x69, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x18, 0x0a,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var (
	...
	file_mcenter_apps_notify_pb_mail_proto_rawDescData []byte
)

func file_mcenter_apps_notify_pb_mail_proto_rawDescGZIP() []byte {
	file_mcenter_apps_notify_pb_mail_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_notify_pb_mail_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_notify_pb_mail_proto_rawDesc), len(file_mcenter_apps_notify_pb_mail_proto_rawDesc)))
	})
...
var file_mcenter_apps_notify_pb_mail_proto_goTypes = []any{
...
func file_mcenter_apps_notify_pb_mail_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_notify_pb_mail_proto_rawDesc), len(file_mcenter_apps_notify_pb_mail_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
