...
var file_mcenter_apps_domain_pb_dingding_proto_rawDesc = []byte{
...
var (
	...
	file_mcenter_apps_domain_pb_dingding_proto_rawDescData = file_mcenter_apps_domain_pb_dingding_proto_rawDesc
)
...
func file_mcenter_apps_domain_pb_dingding_proto_rawDescGZIP() []byte {
	file_mcenter_apps_domain_pb_dingding_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_domain_pb_dingding_proto_rawDescData = protoimpl.X.CompressGZIP(file_mcenter_apps_domain_pb_dingding_proto_rawDescData)
	})
...
func file_mcenter_apps_domain_pb_dingding_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mcenter_apps_domain_pb_dingding_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mcenter_apps_domain_pb_dingding_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_mcenter_apps_domain_pb_dingding_proto_rawDesc = nil
