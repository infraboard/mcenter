...
type DescribeRoleRequest struct {
	...
	// @gotags: bson:"with_permission" json:"with_permission"
	WithPermission bool `protobuf:"varint,3,opt,name=with_permission,json=withPermission,proto3" json:"with_permission" bson:"with_permission"`
...
func (x *DescribeRoleRequest) GetWithPermission() bool {
	if x != nil {
		return x.WithPermission
	}
	return false
...
var file_apps_role_pb_rpc_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x99, 0x01, 0x0a, 0x13, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x52, 0x6f,
	...
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04,
	...
	0x6f, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x2b, 0x0a,
