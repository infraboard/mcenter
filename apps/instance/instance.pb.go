...
type RegistryRequest struct {
	...
	Region string `protobuf:"bytes,1,opt,name=region,proto3" json:"region" bson:"region" toml:"region" yaml:"region" env:"MCENTER_REGION" validate:"required"`
	// 实例所属环境, 默认default
	// @gotags: bson:"environment" json:"environment" toml:"environment" yaml:"environment" env:"MCENTER_ENV" validate:"required"
	Environment string `protobuf:"bytes,2,opt,name=environment,proto3" json:"environment" bson:"environment" toml:"environment" yaml:"environment" env:"MCENTER_ENV" validate:"required"`
	// 实例所属分组,默认default
	// @gotags: bson:"group" json:"group" toml:"group" yaml:"group" env:"MCENTER_GROUP" validate:"required"
	Group string `protobuf:"bytes,3,opt,name=group,proto3" json:"group" bson:"group" toml:"group" yaml:"group" env:"MCENTER_GROUP" validate:"required"`
	// 实例名称
	// @gotags: bson:"name" json:"name" toml:"name" yaml:"name" env:"MCENTER_NAME" validate:"required"
	Name string `protobuf:"bytes,4,opt,name=name,proto3" json:"name" bson:"name" toml:"name" yaml:"name" env:"MCENTER_NAME" validate:"required"`
	// 实例地址
	// @gotags: bson:"address" json:"address" toml:"address" yaml:"address" env:"MCENTER_ADDRESS" validate:"required"
	Address string `protobuf:"bytes,5,opt,name=address,proto3" json:"address" bson:"address" toml:"address" yaml:"address" env:"MCENTER_ADDRESS" validate:"required"`
	// 实例标签, 可以根据标签快速过滤实例
	// @gotags: bson:"tags" json:"tags" toml:"tags" yaml:"tags" env:"MCENTER_TAGS"
	Tags map[string]string `protobuf:"bytes,6,rep,name=tags,proto3" json:"tags" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"tags" toml:"tags" yaml:"tags" env:"MCENTER_TAGS"`
	// 实例构建信息
	// @gotags: bson:"build" json:"build" toml:"build" yaml:"build"
	Build *Build `protobuf:"bytes,7,opt,name=build,proto3" json:"build" bson:"build" toml:"build" yaml:"build"`
}
...
var file_apps_instance_pb_instance_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xc8,
	...
	0x6e, 0x63, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xce, 0x02, 0x0a, 0x0f, 0x52,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x4a, 0x0a, 0x04,
	0x74, 0x61, 0x67, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x69, 0x6e, 0x66,
	0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e,
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x38, 0x0a, 0x05, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	...
	0x6c, 0x64, 0x1a, 0x37, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7a, 0x0a, 0x05, 0x42,
	...
	0x09, 0x52, 0x09, 0x67, 0x69, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x19, 0x0a, 0x08,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x41, 0x74, 0x22, 0x20, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x06, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0x33, 0x0a, 0x10, 0x48, 0x65, 0x61,
	...
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x13, 0x0a, 0x11, 0x55, 0x6e, 0x72, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x14, 0x0a, 0x12, 0x55, 0x6e,
	0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0xc0, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x61, 0x70, 0x70, 0x6c,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x65,
	...
	0x6f, 0x75, 0x70, 0x2a, 0x22, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x13, 0x0a, 0x0f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x4e, 0x53,
	0x54, 0x41, 0x4e, 0x43, 0x45, 0x10, 0x00, 0x32, 0xb1, 0x03, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x67, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x49,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x2c, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x69, 0x6e, 0x73,
	...
	,
...
var file_apps_instance_pb_instance_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_apps_instance_pb_instance_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_apps_instance_pb_instance_proto_goTypes = []interface{}{
	(CommandType)(0),           // 0: infraboard.mcenter.instance.CommandType
	(*Instance)(nil),           // 1: infraboard.mcenter.instance.Instance
	(*Config)(nil),             // 2: infraboard.mcenter.instance.Config
	(*HeartbeatConfig)(nil),    // 3: infraboard.mcenter.instance.HeartbeatConfig
	(*InstanceSet)(nil),        // 4: infraboard.mcenter.instance.InstanceSet
	(*RegistryRequest)(nil),    // 5: infraboard.mcenter.instance.RegistryRequest
	(*Build)(nil),              // 6: infraboard.mcenter.instance.Build
	(*Status)(nil),             // 7: infraboard.mcenter.instance.Status
	(*HeartbeatRequest)(nil),   // 8: infraboard.mcenter.instance.HeartbeatRequest
	(*RemoteCommand)(nil),      // 9: infraboard.mcenter.instance.RemoteCommand
	(*HeartbeatResponse)(nil),  // 10: infraboard.mcenter.instance.HeartbeatResponse
	(*UnregistryRequest)(nil),  // 11: infraboard.mcenter.instance.UnregistryRequest
	(*UnregistryResponse)(nil), // 12: infraboard.mcenter.instance.UnregistryResponse
	(*SearchRequest)(nil),      // 13: infraboard.mcenter.instance.SearchRequest
	nil,                        // 14: infraboard.mcenter.instance.RegistryRequest.TagsEntry
	nil,                        // 15: infraboard.mcenter.instance.RemoteCommand.ParamsEntry
}
var file_apps_instance_pb_instance_proto_depIdxs = []int32{
	5,  // 0: infraboard.mcenter.instance.Instance.registry_info:type_name -> infraboard.mcenter.instance.RegistryRequest
	7,  // 1: infraboard.mcenter.instance.Instance.status:type_name -> infraboard.mcenter.instance.Status
	2,  // 2: infraboard.mcenter.instance.Instance.config:type_name -> infraboard.mcenter.instance.Config
	3,  // 3: infraboard.mcenter.instance.Config.heartbeat:type_name -> infraboard.mcenter.instance.HeartbeatConfig
	1,  // 4: infraboard.mcenter.instance.InstanceSet.items:type_name -> infraboard.mcenter.instance.Instance
	14, // 5: infraboard.mcenter.instance.RegistryRequest.tags:type_name -> infraboard.mcenter.instance.RegistryRequest.TagsEntry
	6,  // 6: infraboard.mcenter.instance.RegistryRequest.build:type_name -> infraboard.mcenter.instance.Build
	0,  // 7: infraboard.mcenter.instance.RemoteCommand.type:type_name -> infraboard.mcenter.instance.CommandType
	15, // 8: infraboard.mcenter.instance.RemoteCommand.params:type_name -> infraboard.mcenter.instance.RemoteCommand.ParamsEntry
	9,  // 9: infraboard.mcenter.instance.HeartbeatResponse.remote_command:type_name -> infraboard.mcenter.instance.RemoteCommand
	5,  // 10: infraboard.mcenter.instance.Service.RegistryInstance:input_type -> infraboard.mcenter.instance.RegistryRequest
	8,  // 11: infraboard.mcenter.instance.Service.Heartbeat:input_type -> infraboard.mcenter.instance.HeartbeatRequest
	11, // 12: infraboard.mcenter.instance.Service.UnRegistry:input_type -> infraboard.mcenter.instance.UnregistryRequest
	13, // 13: infraboard.mcenter.instance.Service.Search:input_type -> infraboard.mcenter.instance.SearchRequest
	1,  // 14: infraboard.mcenter.instance.Service.RegistryInstance:output_type -> infraboard.mcenter.instance.Instance
	10, // 15: infraboard.mcenter.instance.Service.Heartbeat:output_type -> infraboard.mcenter.instance.HeartbeatResponse
	12, // 16: infraboard.mcenter.instance.Service.UnRegistry:output_type -> infraboard.mcenter.instance.UnregistryResponse
	4,  // 17: infraboard.mcenter.instance.Service.Search:output_type -> infraboard.mcenter.instance.InstanceSet
