...
type RegistryRequest struct {
	...
	Labels map[string]string `protobuf:"bytes,9,rep,name=labels,proto3" json:"labels" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" bson:"labels" toml:"labels" yaml:"labels" env:"MCENTER_INSTANCE_LABELS"`
	// 实例元数据
	// @gotags: bson:"meta" json:"meta" toml:"meta" yaml:"meta" env:"MCENTER_INSTANCE_META"
	Meta map[string]string `protobuf:"bytes,11,rep,name=meta,proto3" json:"meta" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" bson:"meta" toml:"meta" yaml:"meta" env:"MCENTER_INSTANCE_META"`
	// 实例构建信息
...
type RemoteCommand struct {
	...
	Params        map[string]string `protobuf:"bytes,2,rep,name=params,proto3" json:"params" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" bson:"params"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_mcenter_apps_instance_pb_instance_proto_rawDesc = string([]byte{
...
var (
	...
	file_mcenter_apps_instance_pb_instance_proto_rawDescData []byte
)
...
func file_mcenter_apps_instance_pb_instance_proto_rawDescGZIP() []byte {
	file_mcenter_apps_instance_pb_instance_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_instance_pb_instance_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_instance_pb_instance_proto_rawDesc), len(file_mcenter_apps_instance_pb_instance_proto_rawDesc)))
	})
...
var file_mcenter_apps_instance_pb_instance_proto_goTypes = []any{
...
func file_mcenter_apps_instance_pb_instance_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_instance_pb_instance_proto_rawDesc), len(file_mcenter_apps_instance_pb_instance_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
