...
type Token struct {
	...
	Meta          map[string]string `protobuf:"bytes,19,rep,name=meta,proto3" json:"meta,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" bson:"meta"`
...
var file_mcenter_apps_token_pb_token_proto_rawDesc = string([]byte{
...
var (
	...
	file_mcenter_apps_token_pb_token_proto_rawDescData []byte
)

func file_mcenter_apps_token_pb_token_proto_rawDescGZIP() []byte {
	file_mcenter_apps_token_pb_token_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_token_pb_token_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_token_pb_token_proto_rawDesc), len(file_mcenter_apps_token_pb_token_proto_rawDesc)))
	})
...
var file_mcenter_apps_token_pb_token_proto_goTypes = []any{
...
func file_mcenter_apps_token_pb_token_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_token_pb_token_proto_rawDesc), len(file_mcenter_apps_token_pb_token_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
