...
type CreatePolicyRequest struct {
	...
	Extra map[string]string `protobuf:"bytes,14,rep,name=extra,proto3" json:"extra" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" bson:"extra"`
	// 标签
...
var file_mcenter_apps_policy_pb_policy_proto_rawDesc = string([]byte{
...
var (
	...
	file_mcenter_apps_policy_pb_policy_proto_rawDescData []byte
)
...
func file_mcenter_apps_policy_pb_policy_proto_rawDescGZIP() []byte {
	file_mcenter_apps_policy_pb_policy_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_policy_pb_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_policy_pb_policy_proto_rawDesc), len(file_mcenter_apps_policy_pb_policy_proto_rawDesc)))
	})
...
var file_mcenter_apps_policy_pb_policy_proto_goTypes = []any{
...
func file_mcenter_apps_policy_pb_policy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_policy_pb_policy_proto_rawDesc), len(file_mcenter_apps_policy_pb_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
