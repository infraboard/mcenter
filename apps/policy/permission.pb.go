...
type CheckPermissionRequest struct {
	...
	ForceCheck    bool `protobuf:"varint,8,opt,name=force_check,json=forceCheck,proto3" json:"force_check"`
...
func (x *CheckPermissionRequest) GetForceCheck() bool {
	if x != nil {
		return x.ForceCheck
	}
	return false
...
var file_mcenter_apps_policy_pb_permission_proto_rawDesc = string([]byte{
	...
	0x61, 0x67, 0x65, 0x2f, 0x70, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf3,
	...
	0x61, 0x74, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x5f, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var (
	...
	file_mcenter_apps_policy_pb_permission_proto_rawDescData []byte
)
...
func file_mcenter_apps_policy_pb_permission_proto_rawDescGZIP() []byte {
	file_mcenter_apps_policy_pb_permission_proto_rawDescOnce.Do(func() {
		file_mcenter_apps_policy_pb_permission_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcenter_apps_policy_pb_permission_proto_rawDesc), len(file_mcenter_apps_policy_pb_permission_proto_rawDesc)))
	})
...
var file_mcenter_apps_policy_pb_permission_proto_goTypes = []any{
...
func file_mcenter_apps_policy_pb_permission_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcenter_apps_policy_pb_permission_proto_rawDesc), len(file_mcenter_apps_policy_pb_permission_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
